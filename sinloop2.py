...
# Loop extrusion force
    ...
    for i in range(2, 59):
        ...
        for j in range(MATRIX_LENGTH):
            ...
            le_force.setBondParameters(i - 2, p1, p2, 1 * u.angstrom,
                                    le_force_two)
            le_force.setBondParameters(i - 1, p1, p2 + 1, 1 * u.angstrom, le_force_one)
    ...
    #        simulation.step(1)
        plot_data(STATE_FNAME, '1sided-energy.png')
    simulation.step(200)
    plot_data(STATE_FNAME, '1sided-energy.png')
